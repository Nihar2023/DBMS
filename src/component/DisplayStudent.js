            ...
            <table className="table table-dark table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Course</th> {/* Added Course Header */}
                    ...
                    {props.students.map((element, i) => {
                        return (
                            <tr key={i}>
                                ...
                                <td>{element.course}</td> {/* Display Course */}
                                <td className='text-decoration-none text-center'>
                                    <Link to={'/edit/' + i}>✎</Link>
                                </td>
                                <td className='text-center cursor' onClick={() => { props.deleteStudent(i) }}>
                                    🗑
                                </td>
                            </tr>
                        );
